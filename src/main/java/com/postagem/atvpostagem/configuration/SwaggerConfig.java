package com.postagem.atvpostagem.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("com.postagem.atvpostagem.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/JadyLinnit")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Jady Linnit", 
			"https://github.com/JadyLinnit", 
			"linnitjady@gmail.com");
